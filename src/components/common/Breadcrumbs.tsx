...
// Hàm giúp "dịch" một phần đường dẫn sang tên hiển thị thân thiện hơn
// Bạn có thể mở rộng map này cho các trang khác
const pathNameMap: { [key: string]: string } = {
  ...
  // Ví dụ cho sản phẩm cụ thể (để hiển thị tên sản phẩm thay vì ID)
  // '1': 'Laptop Gigabyte G5 KF5-53VN383SH' (cần logic phức tạp hơn để lấy tên thật)
};
